...
const useStyles = makeStyles({
  ...
  reviewCommentUserInner: {
    display: 'flex',
    webkitBoxAlign: 'center',
    alignItems: 'center',
  },
  reviewCommentUserAvatar: {
  ...
  reviewCommentSellerNameAttributes: {
    display: 'flex',
    webkitBoxAlign: 'center',
    alignItems: 'center',
    margin: '0px 0px 16px',
  },
  reviewCommentSellerName: {
    display: 'flex',
    webkitBoxAlign: 'center',
    alignItems: 'center',
    fontSize: '13px',
  ...
  formSearchForm: {
    ...
    display: 'flex',
    position: 'relative',
    boxShadow: '#626262 50% 0px 1px 2px 0px',
  },
  formSearchInput: {
    border: '0px',
    padding: '0px 12px',
